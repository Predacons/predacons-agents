...
try:
    ...
    print("Predacons not installed. Please install Predacons to use the PredaconsEmbedding class. else use custom embedding like openai")
...
class VectorStore:
    ...
    def __init__(self, chroma_path, document_path, model=None,custom_embedding = None):
        
        """
        Initialize the VectorStore with paths and an optional model or custom embedding.

        :param chroma_path: str - Path to the Chroma database.
        :param document_path: str - Path to the directory containing documents.
        :param model: Optional[str] - Optional model ID for the embedder. Default is None.
        :param custom_embedding: Optional[object] - Optional custom embedding object. Default is None.

        """
        if custom_embedding:
            self.embedder = custom_embedding
        else:
